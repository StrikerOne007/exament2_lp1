...
<body class="min-h-screen bg-black text-gray-200 ">
    <div
        ...
        style="background-image: url('./assets/images/header-image.png');"
    >
        <div class="bg-black/80"><!-- class="bg-black/80" -->
            ...
            <section class="max-w-7xl mx-auto px-6 py-6 grid grid-cols-12 gap-4 items-end">  <!-- border-white -->
                ...
                <div class="col-span-4 flex justify-end gap-2">
                    <button class="border border-white/30 text-white px-3 py-1  rounded">
                        Tabla
                    </button>
                    <button class="border border-white/30 text-white px-3 py-1 rounded">
                        Tarjetas
    ...
    <main>
        <div class="overflow-x-auto max-w-7xl mx-auto px-6">
            <table class="table">
                <thead>
                <tr>
                    <th>ID</th>
        ...
        <div class="grid grid-cols-6 gap-4 items-center max-w-7xl mx-auto px-6 py-8">
            <%
                if (listaMovies != null) {
                    for (Movie movie : listaMovies) {
            %>
                <div>
                    <div class="card card-side bg-base-100 shadow-sm mb-1">
                        <figure>
                            <img
                    ...
                    <p class="px-2 py-1 text-sm font-medium"><%= movie.getTitle() %></p>
                    <p class="px-2 text-xs text-gray-400"><%= movie.getYear() %> | <%= movie.getRating() %></p>
                </div>
            <%
                    }
                }
